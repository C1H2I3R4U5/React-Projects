        ...
        <div className="container">
          <div className="row g-5">
            ...
            <div className="col-lg-6 wow fadeInUp" data-wow-delay="0.3s">
              ...
              <p className="mb-4">
                Traveling is more than just exploring new destinations—it's
                about enriching your life, broadening your perspectives, and
                creating memories that last a lifetime. At Sundari Tours and
                Travels, we believe that every journey should be as unique as
                the traveler embarking on it. Whether you’re seeking serene
                landscapes, vibrant cultures, or thrilling adventures, we’re
                here to make your travel dreams come true.
              </p>
              <p className="mb-4">
                Let’s Start Your Journey Your adventure begins the moment you
                decide to explore the world. Let us take care of the details so
                you can focus on what matters most—creating unforgettable
                memories. Whether you’re dreaming of a tropical escape, a
                cultural immersion, or an epic adventure, Sundari Tours and
                Travels is here to make it a reality.
              </p>
            ...
            >
              <div className="package-item">
                ...
                <div className="text-center p-4">
                  ...
                  <p>
                    Discover the vibrant beauty of Thailand—a land of stunning
                    beaches, rich culture, and unforgettable experiences.
                    Explore our site to find your next adventure in this exotic
                    paradise!
                  </p>
            ...
            >
              <div className="package-item">
                ...
                <div className="text-center p-4">
                  ...
                  <p>
                    Discover the vibrant beauty of Indonesia, where lush
                    landscapes, stunning beaches, and rich cultural heritage
                    come together. Explore this enchanting destination and
                    experience the unique charm of its diverse islands and
                    traditions
                  </p>
                  <div className="d-flex justify-content-center mb-2">
                    <a
            ...
            >
              <div className="package-item">
                ...
                <div className="text-center p-4">
                  ...
                  <p>
                    Discover the breathtaking landscapes of Australia, where
                    stunning coastlines, vibrant cities, and rich cultural
                    heritage create an unforgettable adventure. From the iconic
                    Sydney Opera House to the majestic Great Barrier Reef,
                    Australia offers experiences like no other
                  </p>
                  <div className="d-flex justify-content-center mb-2">
                    <a
                      href="#"
            ...
            >
              <div className="package-item">
                ...
                <div className="text-center p-4">
                  ...
                  <p>
                    Discover the enchanting beauty of Goa, where golden beaches
                    meet vibrant culture. Whether you're seeking adventure or
                    relaxation, Goa offers an unforgettable escape
                  </p>
                  <div className="d-flex justify-content-center mb-2">
                    <a
                      href="#"
            ...
            >
              <div className="package-item">
                ...
                <div className="text-center p-4">
                  ...
                  <p>
                    Discover the vibrant beauty of Malaysia—where stunning
                    landscapes meet rich cultural heritage. From the iconic
                    Petronas Towers to the lush rainforests, Malaysia offers an
          ...
          <div className="booking p-5">
            <div className="row g-5 align-items-center">
              <div className="col-md-6 text-white">
                ...
                <p className="mb-4">
                  Secure your trip instantly with our fast and safe online
                  payment options. Convenient online payments make booking your
                  adventure hassle-free and secure
                </p>
          ...
          <div className="row gy-5 gx-4 justify-content-center">
            ...
            >
              <div className="position-relative border border-primary pt-5 pb-4 px-4">
                ...
                <p className="mb-0">
                  Pick your dream destination with ease from our extensive
                  global network.Pick your dream destination with ease from our
            ...
            >
              <div className="position-relative border border-primary pt-5 pb-4 px-4">
                ...
                <hr className="w-50 mx-auto bg-primary mt-0" />
                <p className="mb-0">
                  Book now, fly today—your spontaneous adventure starts whenever
                  you're ready.Seize the moment and take off today with our
                  flexible, last-minute booking options.
                </p>
              </div>
            </div>
          </div>

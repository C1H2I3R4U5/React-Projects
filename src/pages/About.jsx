      ...
      <div className="container">
        <div className="row g-5">
          ...
          <div className="col-lg-6 wow fadeInUp" data-wow-delay="0.3s">
            ...
            <h1 className="mb-4">
              Welcome to <span className="text-primary">Toursim</span>
            </h1>
            <p className="mb-4">
            Discover the World with Us: Your Gateway to Unforgettable Adventures: <br></br>

                Traveling is more than just exploring new destinations—it's about enriching your
                life, broadening your perspectives, and creating memories that last a lifetime. At [Your Company Name], we believe that every journey should be as unique as the traveler embarking on it. Whether you’re seeking serene landscapes, vibrant cultures, or thrilling adventures, we’re here to make your travel dreams come true.
            </p>
            <p className="mb-4">
